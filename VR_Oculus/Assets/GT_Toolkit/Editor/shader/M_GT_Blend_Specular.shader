Shader "M_GT_Blend_Specular"
{
	Properties
	{
		...
		[NoScaleOffset]_AlbedoTop("Albedo [Alpha] (Top)", 2D) = "white" {}
		_BaseColorTintTop("Albedo Tint (Top)", Color) = (1,1,1,0)
		[NoScaleOffset]_SpecularGlossinessTop("Specular [Glossiness] (Top)", 2D) = "white" {}
		_GlossinessMultiplierTop("Glossiness Multiplier (Top)", Range(0 , 10)) = 0
		[Toggle(_INVERTGLOSSINESSTOP_ON)] _InvertGlossinessTop("Invert Glossiness (Top)", Float) = 0
		[NoScaleOffset]_HeightTop("Height (Top)", 2D) = "white" {}
		[NoScaleOffset][Normal]_NormalAmbientOcclusionTop("Normal [AmbientOcclusion] (Top)", 2D) = "white" {}
		...
		[NoScaleOffset]_AlbedoAlphaBase("Albedo [Alpha] (Base)", 2D) = "white" {}
		_BaseColorTintBase("Base Color Tint (Base)", Color) = (1,1,1,0)
		[NoScaleOffset]_SpecularGlossinessBase("Specular [Glossiness] (Base)", 2D) = "white" {}
		_GlossinessMultiplierBase("Glossiness Multiplier (Base)", Range( 0 , 10)) = 0
		[Toggle(_INVERTGLOSSINESSBASE_ON)] _InvertGlossinessBase("Invert Glossiness (Base)", Float) = 0
		[NoScaleOffset]_HeightBase("Height (Base)", 2D) = "white" {}
		[NoScaleOffset][Normal]_NormalAmbientOcclusionBase("Normal [AmbientOcclusion] (Base)", 2D) = "white" {}
		[Toggle(_INVERT_NORMAL_ON)] _Invert_Normal("Invert Normal (Base)", Float) = 0
	...
	SubShader
	{
		...
		#pragma shader_feature _INVERTGLOSSINESSTOP_ON
		#pragma shader_feature _INVERTGLOSSINESSBASE_ON
		...
		uniform sampler2D _NormalAmbientOcclusionTop;
		...
		uniform sampler2D _NormalAmbientOcclusionBase;
		...
		uniform sampler2D _AlbedoAlphaBase;
		...
		uniform sampler2D _SpecularGlossinessTop;
		uniform sampler2D _SpecularGlossinessBase;
		uniform float _GlossinessMultiplierTop;
		uniform float _GlossinessMultiplierBase;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode91 = tex2D( _NormalAmbientOcclusionTop, lerpResult84, ddx( uv_TexCoord76 ), ddy( uv_TexCoord76 ) );
			...
			float4 tex2DNode46 = tex2D( _NormalAmbientOcclusionBase, lerpResult26, ddx( uv_TexCoord12 ), ddy( uv_TexCoord12 ) );
			...
			float4 tex2DNode98 = tex2D( _AlbedoTop, lerpResult84 );
			float4 tex2DNode34 = tex2D( _AlbedoAlphaBase, lerpResult26 );
			...
			float4 tex2DNode86 = tex2D( _SpecularGlossinessTop, lerpResult84 );
			float4 tex2DNode38 = tex2D( _SpecularGlossinessBase, lerpResult26 );
			float4 lerpResult117 = lerp( tex2DNode86 , tex2DNode38 , HeightMask127);
			o.Metallic = lerpResult117.r;
			#ifdef _INVERTGLOSSINESSTOP_ON
				float staticSwitch101 = ( 1.0 - tex2DNode86.a );
			#else
				float staticSwitch101 = tex2DNode86.a;
			#endif
			#ifdef _INVERTGLOSSINESSBASE_ON
				float staticSwitch39 = ( 1.0 - tex2DNode38.a );
			#else
				float staticSwitch39 = tex2DNode38.a;
			#endif
			float lerpResult118 = lerp( ( _GlossinessMultiplierTop * staticSwitch101 ) , ( _GlossinessMultiplierBase * staticSwitch39 ) , HeightMask127);
			o.Smoothness = lerpResult118;
			float lerpResult119 = lerp( ( tex2DNode91.a / _AmbientOcclusionMultiplierTop ) , ( tex2DNode46.a / _AmbientOcclusionMultiplierBase ) , HeightMask127);
...
/*ASEBEGIN
Version=15301
398;239;1889;805;4068.279;-632.0674;2.526136;True;True
...
Node;AmplifyShaderEditor.CommentaryNode;85;-1213.823,2333.586;Float;False;987.1981;456.6984;DET [Metallic, Roughness, Ambient Occlusion];8;111;110;103;102;101;94;90;86;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;45;-1163.678,178.5952;Float;False;987.1981;456.6984;DET [Metallic, Roughness, Ambient Occlusion];8;59;38;41;39;42;40;65;66;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;89;-1207.526,1866.485;Float;False;841.5138;434.4994;Normal;6;96;105;91;106;100;93;;1,1,1,1;0;0
Node;AmplifyShaderEditor.DdyOpNode;88;-2231.22,2665.388;Float;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.CommentaryNode;51;-1157.381,-288.5056;Float;False;846.5138;435.4994;Normal;6;44;46;60;48;50;49;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;86;-1162.047,2383.586;Float;True;Property;_SpecularGlossinessTop;Specular [Glossiness] (Top);8;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;38;-1113.678,228.5952;Float;True;Property;_SpecularGlossinessBase;Specular [Glossiness] (Base);7;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;91;-1157.526,2067.984;Float;True;Property;_NormalAmbientOcclusionTop;Normal [AmbientOcclusion] (Top);17;2;[NoScaleOffset];[Normal];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;98;-1084.006,1619.79;Float;True;Property;_AlbedoTop;Albedo (Top);3;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;34;-1033.86,-535.201;Float;True;Property;_AlbedoAlphaBase;Albedo [Alpha] (Base);2;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;39;-638.4796,324.5944;Float;False;Property;_InvertGlossinessBase;Invert Glossiness (Base);12;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-630.4785,242.9939;Float;False;Property;_GlossinessMultiplierBase;Glossiness Multiplier (Base);10;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;96;-839.7237,2223.318;Float;False;Property;_AmbientOcclusionMultiplierTop;Ambient Occlusion Multiplier (Top);13;0;Create;True;0;0;False;0;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;94;-680.6247,2397.984;Float;False;Property;_GlossinessMultiplierTop;Glossiness Multiplier (Top);9;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-809.4851,74.95824;Float;False;Property;_AmbientOcclusionMultiplierBase;Ambient Occlusion Multiplier (Base);14;0;Create;True;0;0;False;0;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;101;-688.6259,2479.585;Float;False;Property;_InvertGlossinessTop;Invert Glossiness (Top);11;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;131;283.6801,1131.422;Float;False;234;206;Glossiness;1;118;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;129;287.7708,1562.633;Float;False;234;206;Emissive;1;120;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;132;282.2719,917.4864;Float;False;234;206;Specular Color;1;117;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;60;-462.6631,16.505;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;105;-514.0738,2175.24;Float;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;117;332.2719,967.4862;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=20C78E12812D98D54A7FD590F223D58321AA55E7